...
class PatientsTest < ApplicationSystemTestCase
  ...
  test "creating a Patient" do
    ...
    fill_in "Discountrate", with: @patient.discountrate
    fill_in "Docotrvisit", with: @patient.docotrvisit
    fill_in "Insurancenumber", with: @patient.insurancenumber
    fill_in "Name", with: @patient.name
    fill_in "Paionenddate", with: @patient.paionenddate
    fill_in "Paionstartdate", with: @patient.paionstartdate
    fill_in "Quota", with: @patient.quota
