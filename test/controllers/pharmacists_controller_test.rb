...
class PharmacistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pharmacist" do
    assert_difference('Pharmacist.count') do
      post pharmacists_url, params: { pharmacist: { address: @pharmacist.address, isactive: @pharmacist.isactive, name: @pharmacist.name, phone: @pharmacist.phone } }
    end
  ...
  test "should update pharmacist" do
    patch pharmacist_url(@pharmacist), params: { pharmacist: { address: @pharmacist.address, isactive: @pharmacist.isactive, name: @pharmacist.name, phone: @pharmacist.phone } }
