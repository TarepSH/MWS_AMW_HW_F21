...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { composition: @drug.composition, name: @drug.name, price: @drug.price } }
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { composition: @drug.composition, name: @drug.name, price: @drug.price } }
